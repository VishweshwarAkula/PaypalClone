...
export function SignupForm({email, setEmail, password, setPassword, username, setUsername, handleSubmit, setIsSignUp}) {
  return (
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                ...
                <a onClick={() => setIsSignUp(false)} className="font-medium text-blue-600 hover:underline dark:text-blue-500 cursor-pointer">
                  Login here
                </a>
              </p>
            </form>
